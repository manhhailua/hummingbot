...
OTHER_DOMAINS = ["backpack_us"]
OTHER_DOMAINS_PARAMETER = {"backpack_us": "us"}
OTHER_DOMAINS_EXAMPLE_PAIR = {"backpack_us": "BTC-USDT"}
OTHER_DOMAINS_DEFAULT_FEES = {"backpack_us": DEFAULT_FEES}


class BackpackUSConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="backpack_us", const=True, client_data=None)
    backpack_api_key: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your Backpack US API key",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        ),
    ...
    backpack_api_secret: SecretStr = Field(
        default=...,
        client_data=ClientFieldData(
            prompt=lambda cm: "Enter your Backpack US API secret",
            is_secure=True,
            is_connect_key=True,
            prompt_on_new=True,
        ),
...
OTHER_DOMAINS_KEYS = {"backpack_us": BackpackUSConfigMap.construct()}

...
class BackpackUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = BackpackAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
    ...
    @patch("hummingbot.connector.exchange.backpack.backpack_api_user_stream_data_source.BackpackAPIUserStreamDataSource"
           "._ping_listen_key",
